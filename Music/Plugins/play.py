...
@Client.on_message(command(["play", "غزال" ,"شغل" ,"تشغيل", f"/play@{BOT_USERNAME}", "تشغيل"]))
...
`تشغيل او شغل او غزال + أسم المقطع الصوتي 🎧`
""",
            )
            return
        what = "Query Given"
        ...
        thumb ="https://telegra.ph/MUSIC-05-21-2"
